 ...
 * marked lost. Deal `id` is a `faker.string.numeric(10)` 10-digit numeric
 * string; LineItem `id` remains a `faker.string.uuid()` — neither is ever a
 * sequential counter or array index (research/PITFALLS.md Pitfall 1/5).
 * Every field is generated by faker's fictional generators — never real
 * prospect/company/person data, even for internal demos.
 */
