...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/gh-repos/eld/.claude/.gsd-surface.json`
(sibling to `C:/gh-repos/eld/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/gh-repos/eld/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/gh-repos/eld/.claude/skills`).
...
`C:/gh-repos/eld/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/gh-repos/eld/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/gh-repos/eld/.claude/.gsd-surface.json`
Install profile marker: `C:/gh-repos/eld/.claude/.gsd-profile`
Skill dirs: `C:/gh-repos/eld/.claude/skills/gsd-*/`
Engine module: `C:/gh-repos/eld/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/gh-repos/eld/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
