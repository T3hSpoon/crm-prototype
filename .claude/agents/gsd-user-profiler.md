...
<reference>
@C:/gh-repos/eld/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/gh-repos/eld/.claude/gsd-core/references/user-profiling.md` to load:
