...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/gh-repos/eld/.claude
                  → checks C:/gh-repos/eld/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/gh-repos/eld/.claude/gsd-core
                  → writes to C:/gh-repos/eld/.claude/gsd-core/hooks/
