...
<required_reading>
@C:/gh-repos/eld/.claude/gsd-core/references/ai-frameworks.md
@C:/gh-repos/eld/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/gh-repos/eld/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/gh-repos/eld/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/gh-repos/eld/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/gh-repos/eld/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/gh-repos/eld/.claude/agents/gsd-eval-planner.md for instructions.
