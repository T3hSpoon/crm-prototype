...
<template>
@C:/gh-repos/eld/.claude/gsd-core/templates/UAT.md
</template>
...
Read and follow `C:/gh-repos/eld/.claude/gsd-core/workflows/transition.md`.
...
- Follow @C:/gh-repos/eld/.claude/gsd-core/workflows/diagnose-issues.md
