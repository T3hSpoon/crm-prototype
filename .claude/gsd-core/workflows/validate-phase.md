...
```
Agent(
  prompt="Read C:/gh-repos/eld/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/gh-repos/eld/.claude/gsd-core/templates/VALIDATION.md`
