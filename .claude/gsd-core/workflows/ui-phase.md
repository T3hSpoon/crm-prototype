...
```markdown
Read C:/gh-repos/eld/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/gh-repos/eld/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/gh-repos/eld/.claude/agents/gsd-ui-checker.md for instructions.
...
@C:/gh-repos/eld/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / C:/gh-repos/eld/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "C:/gh-repos/eld/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "C:/gh-repos/eld/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
