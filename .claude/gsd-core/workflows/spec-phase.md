...
ones). Reference: @C:/gh-repos/eld/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/gh-repos/eld/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/gh-repos/eld/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/gh-repos/eld/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/gh-repos/eld/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/gh-repos/eld/.claude/gsd-core/templates/spec.md.
