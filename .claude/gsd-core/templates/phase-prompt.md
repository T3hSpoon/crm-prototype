...
<!-- For checkpoint task examples and patterns, see @C:/gh-repos/eld/.claude/gsd-core/references/checkpoints.md -->
...
See `C:/gh-repos/eld/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/gh-repos/eld/.claude/gsd-core/templates/user-setup.md` for full schema and examples
