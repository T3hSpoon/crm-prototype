...
- [ ] **Phase 1: Pipeline Board Foundation** - Grouped pipeline table with mock data, add-deal form, and stage-to-stage moves
...
- [ ] 01-01-PLAN.md — Node.js version fix, package-legitimacy gate, Vite/React/TS scaffold + Tailwind v4/shadcn/ui

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 01-02-PLAN.md — Deal data contracts, mock repository, Zustand store, tracer render (end-to-end data seam)

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 01-03-PLAN.md — Grouped pipeline board UI (5 stage sections) — PIPE-01

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 01-04-PLAN.md — Add Deal modal form + per-row stage-move control — DEAL-01, PIPE-02
...
|-------|----------------|--------|-----------|
| 1. Pipeline Board Foundation | 0/TBD | Not started | - |
| 2. Deal Detail & Line Items | 0/TBD | Not started | - |
