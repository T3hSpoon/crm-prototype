...
- [x] **Phase 3.1: Lost & Won Tracking (INSERTED)** - Explicit lost-deal flow with required reason, plus a contract terms form on Won and Won deals as the contracts list (completed 2026-09-14)
- [x] **Phase 4: Forecast & Pipeline Analysis** - Search/filter/sort plus a forecast page with weighted pipeline value and win rate (completed 2026-09-15)
...
- [x] 03.1-01-PLAN.md — Lost-reason gate: Popover primitive, moveToLost action, StageSelect intercept (LOST-01, LOST-02)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 03.1-02-PLAN.md — Won contract-terms gate: "won" group registration, moveToWon action, WonContractTermsDialog (PIPE-03, WON-01)
...
- [x] 04-01-PLAN.md — Pipeline search/filter/sort: shared toolbar, all 6 tables, sync'd sort/filter state (PIPE-04, PIPE-05, PIPE-06)
- [x] 04-02-PLAN.md — CR-01 stale-field fix + Forecast page: stat tiles, lost-by-reason/lost-by-stage charts (FCST-01, FCST-02)
