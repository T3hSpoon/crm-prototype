...
- [x] **PIPE-04**: User can search deals by name/company across the pipeline table
- [x] **PIPE-05**: User can filter the pipeline table by owner, value, stage, or close date
- [x] **PIPE-06**: User can sort the pipeline table by column (value, close date, owner)
...
- [x] **FCST-01**: User can view a forecast page showing raw pipeline value, weighted/projected value (deal value × stage probability), and win rate
- [x] **FCST-02**: User can view a breakdown of lost deals by reason and by stage on the forecast page
...
| FCST-01 | Phase 4 | Complete |
| FCST-02 | Phase 4 | Complete |
